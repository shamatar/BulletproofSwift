...
public struct GeneralizedPrimeFieldElement<U>: FieldBound where U: PrimeFieldProtocol {
    public typealias Field = U
    public typealias SelfType = GeneralizedPrimeFieldElement<U>
    
    public static func fromValue(_ a: BigUInt, field: Field) -> GeneralizedPrimeFieldElement<U> {
        let reduced = field.fromValue(a)
        return GeneralizedPrimeFieldElement<U>(reduced, field)
    }
    
    public static func fromValue(_ a: BytesRepresentable, field: Field) -> GeneralizedPrimeFieldElement<U> {
        let reduced = field.fromValue(a)
        return GeneralizedPrimeFieldElement<U>(reduced, field)
    }
    
    public static func fromValue(_ a: U.UnderlyingRawType, field: Field) -> GeneralizedPrimeFieldElement<U> {
        let reduced = field.fromValue(a)
        return GeneralizedPrimeFieldElement<U>(reduced, field)
    }
    
    public static func fromValue(_ a: UInt64, field: Field) -> GeneralizedPrimeFieldElement<U> {
        let reduced = field.fromValue(a)
        return GeneralizedPrimeFieldElement<U>(reduced, field)
    }
    
    public static func fromBytes(_ a: Data, field: Field) -> GeneralizedPrimeFieldElement<U> {
    ...
    public static func identityElement(_ field: Field) -> GeneralizedPrimeFieldElement<U> {
        let reduced = field.identityElement
        return GeneralizedPrimeFieldElement<U>(reduced, field)
    }
    
    public static func zeroElement(_ field: Field) -> GeneralizedPrimeFieldElement<U> {
    ...
    public var value: BigUInt {
        get {
            return GeneralizedPrimeFieldElement<U>.toValue(self.rawValue, field: self.field)
...
//            return self.field.toValue(self.rawValue)
    ...
    public static func + (lhs: SelfType, rhs: SelfType) -> SelfType {
        ...
        return GeneralizedPrimeFieldElement(raw, lhs.field)
    }
    public static func - (lhs: SelfType, rhs: SelfType) -> SelfType {
    ...
    public static func * (lhs: BytesRepresentable, rhs: SelfType) -> SelfType {
        ...
        return GeneralizedPrimeFieldElement(raw, rhs.field)
    }
    public static func + (lhs: BytesRepresentable, rhs: SelfType) -> SelfType {
        let newFE = rhs.field.reduce(lhs)
    ...
    public func pow(_ a: BytesRepresentable) -> SelfType {
        ...
        return GeneralizedPrimeFieldElement(raw, self.field)
    }
